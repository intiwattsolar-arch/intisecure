...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-industrial": "linear-gradient(180deg, hsl(40 20% 96%) 0%, hsl(40 15% 92%) 100%)",
        "gradient-accent": "linear-gradient(135deg, hsl(38 95% 52%) 0%, hsl(28 90% 45%) 100%)",
        "gradient-surface": "linear-gradient(180deg, hsl(220 18% 24%) 0%, hsl(220 18% 20%) 100%)",
        "gradient-hero": "linear-gradient(180deg, hsl(215 22% 28%) 0%, hsl(215 22% 22%) 100%)",
      },
      boxShadow: {
        "industrial": "0 4px 24px -4px hsla(220, 20%, 14%, 0.1)",
        "glow": "0 0 24px -8px hsl(38 95% 52% / 0.2)",
        "card": "0 1px 3px hsla(220, 20%, 14%, 0.08), 0 4px 12px hsla(220, 20%, 14%, 0.05)",
      },
    },
  },
